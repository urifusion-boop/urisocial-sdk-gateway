    ...
    <div className="bg-white rounded-2xl shadow-xl p-6 border border-gray-200">
      ...
      <div className="mb-6">
        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-green-50 border border-green-200 mb-3">
          ...
          <span className="text-xs font-semibold text-green-900">Secure Login</span>
        </div>
        <h1 className="text-2xl font-bold text-gray-900 mb-1">Welcome back</h1>
        <p className="text-sm text-gray-600">Continue building amazing features</p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <Button
          type="submit"
          disabled={isLoading}
          className="w-full h-10 text-base font-semibold text-white"
